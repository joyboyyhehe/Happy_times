...
import { createPost, getBranches } from '../../services/firestore.js';
 ...
 */
export default function SuperAdminCreatePost({ onCreated, pop }) {
  ...
  const [form, setForm] = useState({
    ...
    scope: 'all_branches',    // 'all_branches' | 'branch' | 'class'
    branchId: '',
    classId: '',
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.scheduleLater && !form.scheduledFor) { toast.error('Set a schedule date/time'); return; }
